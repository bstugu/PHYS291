...
// Thu Feb 20 11:10:29 2025 by ROOT version 6.32.02
// from TTree Delphes/Analysis tree
// found on file: htautau50000.root
//////////////////////////////////////////////////////////

#ifndef htautau50000_h
#define htautau50000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3937;
   static constexpr Int_t kMaxTrack = 195;
   static constexpr Int_t kMaxTower = 563;
   static constexpr Int_t kMaxEFlowTrack = 195;
   static constexpr Int_t kMaxEFlowPhoton = 352;
   static constexpr Int_t kMaxEFlowNeutralHadron = 183;
   ...
   htautau50000(TTree *tree=0);
   virtual ~htautau50000();
...
#ifdef htautau50000_cxx
htautau50000::htautau50000(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
// Navnet på den filen var htautau50000.root
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/scratch/delphes_ntuples/htautau200000.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Zg50.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/scratch/delphes_ntuples/htautau200000.root");
         //f = new TFile("Zg50.root");
      }
...
htautau50000::~htautau50000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t htautau50000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t htautau50000::LoadTree(Long64_t entry)
{
...
void htautau50000::Init(TTree *tree)
{
...
void htautau50000::Show(Long64_t entry)
{
...
Int_t htautau50000::Cut(Long64_t entry)
{
